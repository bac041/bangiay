   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" placeholder="Nhập tên" required class="box">
            <span>Email :</span>
            <input type="email" name="email" value="<?= $fetch_profile['email']; ?>" placeholder="Nhập email" required class="box">
      ...
      <div class="flex-btn">
         <input type="submit" class="btn" value="Cập nhật tài khoản" name="update_profile">
