...
<section class="user-accounts">
   ...
   <div class="box-container">
      ...
      <div class="box" style="<?php if($fetch_users['id'] == $admin_id){ echo 'display:none'; }; ?>">
         ...
         <p> Mã số tài khoản : <span><?= $fetch_users['id']; ?></span></p>
         ...
         <a href="admin_users.php?delete=<?= $fetch_users['id']; ?>" onclick="return confirm('Bạn muốn xóa tài khoản?');" class="delete-btn">Xóa tài khoản</a>
      </div>
      <?php
      }
      ?>
