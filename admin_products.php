      ...
      <div class="flex">
         ...
         <select name="category" class="box" required>
            <option value="" selected disabled>Chọn danh mục</option>
               <option value="rau">Rau, củ, quả</option> <!--vegitables -->
               <option value="thit">Thịt, cá</option> <!--fruits -->
               <option value="ca">Sản phẩm đóng gói</option> <!--meat -->
               <option value="douong">Đồ uống</option> <!-- fish -->
         </select>
         </div>
         <div class="inputBox">
         <input type="text" min="0" name="price" class="box" required placeholder="Nhập giá">
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Bạn đã chắc sẽ xóa?');">Xóa</a>
      </div>
   </div>
   <?php
      }
