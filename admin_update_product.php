...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="name" placeholder="nhập tên sản phẩm" required class="box" value="<?= $fetch_products['name']; ?>">
      <input type="number" name="price" min="0" placeholder="nhập giá" required class="box" value="<?= $fetch_products['price']; ?>">
      <select name="category" class="box" required>
         <option selected><?= $fetch_products['category']; ?></option>
         <option value="rau">Rau,củ</option> <!-- vegitables -->
         <option value="traicay">Trái cây</option> <!-- fruits -->
         <option value="douong">Đồ uống hữu cơ</option> <!-- meat -->
         <option value="nam">Nấm</option> <!-- fish -->
      </select>
